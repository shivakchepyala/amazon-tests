...
object AmazonPage extends WebBrowser with Eventually with Matchers with StartUpTearDown {
  ...
  def verifyCucumberRecipeBook(): Unit = {
    ...
    val order = driver.findElement(By.xpath(".//*[@class='a-link-normal sc-product-link']/child::span[@class='a-size-medium sc-product-title a-text-bold']")).getText
  ...
  def selectScalaBook(): Unit = {
    ...
    new WebDriverWait(webDriver, 10).until(CustomExpectedCondition.isXpathElementDisplayed(".//*[@class='a-row a-spacing-none']/child::span[2]"))
    val author = MessageReader.getMessage("author")
    driver.findElement(By.xpath(".//*[@class='a-row a-spacing-none']/child::span[2]")).getText.contains(author)
    driver.findElement(By.xpath(".//*[@id='result_0']/descendant::div[@class='a-row a-spacing-small']/descendant::h2")).click()
  }
